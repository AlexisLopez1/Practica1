...
void GameWindow::render()
{
    ...
    glVertex3f(100.0f, 100.0f, 0.0f);  // V0
    glVertex3f(250.0f, 200.0f, 0.0f);  // V1
    glVertex3f(300.0f, 300.0f, 300.0f);  // V2
    
    glVertex3f(550.0f, 0.0f, 0.0f);  // V0
    glVertex3f(250.0f, 200.0f, 0.0f);  // V1
    glVertex3f(250.0f, 300.0f, 300.0f);  // V2
    glEnd();
    ...
    for (i=0; i<360; i+=3)
    {
        ...
        glVertex3f(1000.0f, 700.0f, 1000.0f);
